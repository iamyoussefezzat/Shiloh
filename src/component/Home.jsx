...
const Home = () => {
  ...
  const form = useRef();
    ...
    const sendEmail = (e) => {
      ...
      e.preventDefault();
      emailjs.sendForm('service_tu6d3zk', 'template_4x5hi4c', form.current, 'XuWAXvKXOk8xL4R1F')
        .then((result) => {
  ...
  return (
    ...
    <section className='bannar'>
          <Container>
              <Row>
                  <Col md={7} sm={12}  className="bannartext wow slideInLeft" >
                  ...
                  <Col md={5} sm={12}  className="bannarimgs wow slideInRight">
    ...
    <section className="homesec2">
      ...
      <section className="homesec3" id="latest">
        <div className="sectext wow fadeIn" >
          <h3>Latest builds.</h3>
